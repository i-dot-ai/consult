export const testAccessToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQGV4YW1wbGUuY29tIn0.ignored"; // pragma: allowlist secret
...
export const S3_BUCKET = process.env.AWS_BUCKET_NAME ?? "i-dot-ai-test-consult-data";
