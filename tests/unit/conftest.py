...
def question_with_4_responses():
    ...
    respondent_1 = factories.RespondentFactory(
        themefinder_id=1, consultation=consultation
    )
    respondent_2 = factories.RespondentFactory(
        themefinder_id=2, consultation=consultation
    )
    respondent_3 = factories.RespondentFactory(
        themefinder_id=3, consultation=consultation
    )
    respondent_4 = factories.RespondentFactory(
        themefinder_id=4, consultation=consultation
    )
