...
class TestGetConsultationAndQuestion:
    def test_valid_consultation_and_question(self, consultation, question):
        ...
        result = get_consultation_and_question(consultation.slug, question.slug)
    ...
    def test_invalid_consultation_slug(self, question):
        ...
        with pytest.raises(Http404):
            get_consultation_and_question("invalid-consultation", question.slug)

    def test_invalid_question_slug(self, consultation):
        """Test that invalid question slug raises 404"""
        with pytest.raises(Http404):
            get_consultation_and_question(consultation.slug, "invalid-question")
    ...
    def test_question_belongs_to_different_consultation(self, question):
        ...
        with pytest.raises(Http404):
            get_consultation_and_question(other_consultation.slug, question.slug)
...
class TestGetFilteredResponsesWithThemes:
    ...
    def test_keyword_search(self, question):
        ...
        ResponseFactory(
            question=question, 
            free_text="The quick brown fox jumps over the lazy dog"
        )
        ResponseFactory(
            question=question, 
            free_text="Mary loves the lamb, you know"
        )
...
class TestBuildRespondentDataFast:
    ...
    def test_performance_optimized_structure(self, question):
        ...
        expected_keys = {
            "identifier", "free_text_answer_text", "demographic_data", 
            "themes", "multiple_choice_answer", "evidenceRich"
        }
