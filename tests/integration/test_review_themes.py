...
def test_review_show_response(django_app):
    ...
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_a).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_b).count() == 0
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_a).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_b).count() == 1
    ...
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_a).count() == 0
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_b).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_a).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_b).count() == 1
    ...
    review_response_page = django_app.get(url)
    review_response_page.form["theme"] = [str(theme_a.id)]
    next_response = review_response_page.form.submit().follow()

    # expected answer1 = [A], answer2 = [A, B]
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_a).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_b).count() == 0
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_a).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_b).count() == 1

    # Change answer1 again
    response_id = answer_1.id
    url = reverse(
        "show_response",
        args=(
    ...
    # expected answer1 = [A, B], answer2 = [A, B]
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_a).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_b).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_a).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_b).count() == 1

    # Change answer1 to nothing
    response_id = answer_1.id
    url = reverse(
        "show_response",
        args=(
    ...
    review_response_page = django_app.get(url)
    review_response_page.form["theme"] = []
    next_response = review_response_page.form.submit().follow()
    # expected answer1 = [], answer2 = [A, B]
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_a).count() == 0
    models.ThemeMapping.objects.filter(answer=answer_1, theme=theme_b).count() == 0
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_a).count() == 1
    models.ThemeMapping.objects.filter(answer=answer_2, theme=theme_b).count() == 1
