...
resource "null_resource" "build_consultation_lambda" {
  triggers = {
    ...
    lambda_code  = filemd5("${path.root}/../lambda/consultation_import/consultation_import_handler.py")
  }
...
resource "null_resource" "build_candidate_themes_lambda" {
  triggers = {
    ...
    lambda_code  = filemd5("${path.root}/../lambda/candidate_themes_import/candidate_themes_import_handler.py")
  }
