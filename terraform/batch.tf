module "batch_compute" {
  ...
  source                  = "git::https://github.com/i-dot-ai/i-dot-ai-core-terraform-modules.git//modules/infrastructure/batch-compute-environment?ref=v4.0.1-batch-compute-environment"
...
module "batch_job_mapping" {
  ...
  source                   = "git::https://github.com/i-dot-ai/i-dot-ai-core-terraform-modules.git//modules/infrastructure/batch-job-definitions?ref=v4.1.0-batch-job-definitions"
