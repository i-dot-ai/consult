...
>
  <g id="Layer_2" data-name="Layer 2">
    <g id="Layer_1-2" data-name="Layer 1">
      ...
      <rect fill="#c50878" x="144.87" width="21.82" height="104.15"></rect>

      <circle r="11" cx="11px" fill="#fff" cy="11px"></circle>
      ...
      <circle r="11" cx="36.700001px" fill="#fff" cy="93.682587px"></circle>
    </g>
  </g>
</svg>
