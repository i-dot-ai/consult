...
describe("QuestionCard", () => {
    ...
    it("should render data", () => {
        ...
        expect(getByText(`Q${testData.question.number}: ${testData.question.question_text}`));
    ...
    it("should render inside a tag if clickable is true", () => {
        ...
        expect(questionButton.getAttribute("aria-label"))
            .toEqual(`Click to view question: ${testData.question.question_text}`);
        expect(questionButton.getAttribute("role"))
            .toEqual("button");
        expect(questionButton.getAttribute("title"))
            .toEqual(`Q${testData.question.number}: ${testData.question.question_text}`);
    })
    ...
    it("should not render data if skeleton", () => {
        ...
        expect(queryByText(`Q${testData.question.number}: ${testData.question.question_text}`)).toBeNull();
        expect(queryByText(`${testData.question.total_responses} responses`)).toBeNull();
    })
    ...
    it("should render alternative css if horizontal", () => {
        ...
        expect(getByTestId("horizontal-container").getAttribute("class")).toContain("justify-between");
    })
})