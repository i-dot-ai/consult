...
export default {
  ...
  stories: [
    ...
    },
    {
      ...
      mocks: [
        getMock,
        {...patchMock, throws: new Error("Fetch Failed")},
      ],
      props: { userId: "test-user" },
    },
    {
      name: "4xx Error Get",
      mocks: [
        {...getMock, status: 400, body: undefined},
        patchMock,
      ],
      props: { userId: "test-user" },
    },
    {
      name: "5xx Error Get",
      mocks: [
        {...getMock, status: 500, body: undefined},
        patchMock,
      ],
      props: { userId: "test-user" },
    },
    {
      ...
      mocks: [
        {...getMock, throws: new Error("Fetch Failed")},
        patchMock,
      ],
      props: { userId: "test-user" },
    },
