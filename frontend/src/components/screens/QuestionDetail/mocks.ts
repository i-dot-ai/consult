...
export let answers: ResponseAnswer[] = [
  ...
  },
  {
    ...
    multiple_choice_answer: ["Don't know", "Yes"],
    evidenceRich: true,
    sentiment: null,
    human_reviewed: null,
    is_flagged: false,
  ...
  },
  {
    ...
    demographic_data: {},
    themes: [],
    multiple_choice_answer: ["No answer", "No", "Don't know", "Yes"],
    evidenceRich: null,
    sentiment: null,
    human_reviewed: null,
    is_flagged: false,
...
const filterAnswers = (answers: any[], params: any) => {
  ...
  if (params.searchValue) {
    result = result.filter((item) =>
      item.free_text_answer_text
        .toLocaleLowerCase()
        .includes(params.searchValue.toLocaleLowerCase()),
    );
  }
