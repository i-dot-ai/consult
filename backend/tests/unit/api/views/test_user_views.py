...
class TestUserViewSet:
    ...
    def test_users_detail(self, client, staff_user, staff_user_token):
        url = reverse(
            "user-detail",
    ...
    def test_users_delete(self, client, staff_user, staff_user_token):
        url = reverse(
            "user-detail",
            kwargs={"pk": staff_user.pk},
        )
    ...
    def test_users_bulk_create_success(self, client, staff_user_token):
    ...
    def test_users_bulk_create_failure(self, client, staff_user_token):
    ...
    def test_users_patch_fail(self, client, staff_user, staff_user_token):
    ...
    def test_user_consultations_user_not_found(self, client, staff_user_token):
