...
class QuestionViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        # Count human-reviewed free-text responses per question (for proportion_of_audited_answers)
        reviewed_responses_subquery = Subquery(
        ...
        queryset = queryset.annotate(
            ...
            prefetched_reviewed_responses=Coalesce(reviewed_responses_subquery, Value(0)),
        )
