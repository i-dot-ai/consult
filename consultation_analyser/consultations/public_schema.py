...
#   timestamp: 2024-03-29T23:22:29+00:00
...
class ConsultationResponse(BaseModel):
    ...
    submission_date: datetime = Field(..., description="The submission date of the response")
...
class Section(BaseModel):
    ...
    questions: List[Question] = Field(..., description="The questions in the consultation")
...
class ConsultationWithResponses(BaseModel):
    ...
    consultation: List[Consultation] = Field(..., description="The consultation")
    consultation_responses: List[ConsultationResponse] = Field(..., description="The responses")
