...
#   timestamp: 2024-05-08T17:05:21+00:00
...
class ConsultationResponse(BaseModel):
    ...
    answers: List[Answer] = Field(
        ..., description='The answers in this response', min_items=1
    )
...
class Section(BaseModel):
    ...
    questions: List[Question] = Field(
        ..., description='The questions in the consultation', min_items=1
    )
...
class Consultation(BaseModel):
    ...
    sections: List[Section] = Field(
        ..., description='The sections of the consultation', min_items=1
    )
...
class ConsultationWithResponses(BaseModel):
    ...
    consultation_responses: List[ConsultationResponse] = Field(
        ..., description='The responses', min_items=1
    )
