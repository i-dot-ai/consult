...
def send_job_to_sqs(consultation_code: str):
    ...
    QUEUE_URL = "https://sqs.eu-west-2.amazonaws.com/671657536603/i-dot-ai-dev-consult-batch-job-queue"
    
    # Message body with the consultation_code
    message_body = {
        "jobName": "i-dot-ai-dev-consult-mapping-FARGATE-job",
        "jobQueue": "i-dot-ai-dev-consult-mapping-FARGATE-batch-job-queue",
        "jobDefinition": "i-dot-ai-dev-consult-mapping-FARGATE-batch-job-definition",
        "containerOverrides": {
