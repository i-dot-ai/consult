...
<footer class="py-6 px-0 bg-black text-white text-xs">
    <div class="mx-6">
        <div>
        ...
        <div>
        <ul class="my-2 mx-0 p-0 flex flex-wrap gap-2">
            <li>
                <a data-testid="privacy-link" href="/privacy/">Privacy notice</a>
            </li>
            <li>
                <a href="https://github.com/i-dot-ai/consultation-analyser">Version:</a>
            </li>
        </ul>
        ...
        <div class="flex items-center gap-2 mt-4">
            <AnnounceIcon />
            <span>This is a new service your&nbsp;<a href="https://www.smartsurvey.co.uk/s/GESFSF/">feedback</a> will help us to <span>improve it</span></span>
        </div>
    </div>
</footer>